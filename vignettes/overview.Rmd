...
conducts the RothC calculation for 150 years to establish equilibrium pools, and requires a table on crop inputs and
disallows a weather column with yearly fluctuations in weather data. `spinup_analytical_bodemcoolstof`
...
soil <- data.table(
  ...
  amendment <- data.table(
    ...
    B_C_OF_AMENDMENT = rep(c(1000, 3000, 5000), each = 2),
    P_HC = rep(0.7,6),
