...
that only limited data is needed to run the model, making it flexible to use.
In this case there are not carbon inputs, and hence pools are continually decreasing.
