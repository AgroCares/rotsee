...
Information is required on **individual** crop growth seasons. Following inputs are required:
* Start date of crop growth (B_LU_START, formatted as YYYY-MM-DD)
* End date of crop growth (B_LU_END, formatted as YYYY-MM-DD)
* Crop humification coefficient (B_LU_HC, unitless), representing amount of C remaining after 1 year of decomposition.
