...
functions are omitted from the core calculation code, as different regions use different functions
and calculation methods. While this makes package usage more flexible, it does put additional requirements
on the package user. To facilitate this, several helper functions have been added. These functions are 
outlined below, together with a short description of their origin and an example of using the functions.
...
and C content based on the pedotransfer functions listed in Verstraten et al. (2024). C concent can be given either as an amount
...
## Evapotranspiration factors (**Note: rc_set_refact is not yet available in this branch**)
...
Verstraten, J., van Middelkoop, J. C., Philipsen, A. P., van Dongen, C., Bussink, D. W., van der Bas, A., Velthof, G. L., de Haan, J. J., van Dijk, W., Brolsma, K. M., & van Eekeren, N. (2024). Bemestingsadvies Commissie Bemesting Grasland en Voedergewassen: Versie 2024. Commissie Bemesting Grasland en Voedergewassen. https://edepot.wur.nl/413891 **note: the ptf of clay is not present in this reference, there are referred clay densities based on OM, yet these slightly deviate from the actual equation **
